import { ArrowLeft, ArrowRight, Grid, Home } from 'lucide-react';

interface HighFatigueSupportProps {
...
export function HighFatigueSupport({ onContinueToReset, onReturnToCheckIn, onReturnToService, onBack }: HighFatigueSupportProps) {
  return (
