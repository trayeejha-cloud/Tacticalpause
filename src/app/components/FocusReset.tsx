...
interface FocusResetProps {
  onComplete: () => void;
  onBack: () => void;
}

const prompts = [
  "Look at one steady point.",
  "Take one slow breath.",
  "Relax your jaw and shoulders.",
  "Name what needs your attention next."
];

export function FocusReset({ onComplete, onBack }: FocusResetProps) {
              ...
              <div className="mb-6 flex items-center justify-center relative">
                <svg width="120" height="120" className="transform -rotate-90">
                  ...
                  <circle
                    ...
                    strokeDashoffset={`${2 * Math.PI * 54 * (1 - timeLeft / 15)}`}
