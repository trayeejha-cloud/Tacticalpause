...
interface CognitiveResetIntroProps {
  onStartReset: () => void;
  onSkipToCheck: () => void;
  onBack: () => void;
  onAboutClick?: () => void;
...
export function CognitiveResetIntro({ onStartReset, onSkipToCheck, onBack, onAboutClick }: CognitiveResetIntroProps) {
  return (
